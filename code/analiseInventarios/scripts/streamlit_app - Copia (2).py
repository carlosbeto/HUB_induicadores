            ...
            with st.container(border=True):
                ...
                with comp_col1:
                    with st.container(border=True):
                        ...
                        b1.metric(
                            "Itens contados no mês de referência",
                            fmt_int(row_atual["Contados"]) if pd.notna(row_atual["Contados"]) else "-"
                        )

                        b2.metric(
                            "Baseline do mês de referência",
                            fmt_int(row_atual["Baseline"]) if pd.notna(row_atual["Baseline"]) else "-"
                        )
